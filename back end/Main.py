...
c = Canvas(window, bg="gray16",height=900,width=900)
#filename = PhotoImage(file='bg.gif')
background_label = Label(window)
background_label.place(x=0,y=0,relwidth=1,relheight=1)
frame1 = tk.Frame(window)
label_title = tk.Label(frame1, text=" QWSS ")
...
#btn1_image = Image.open('icons/theft.jpg')
...
#btn8_image = Image.open('icons/face.png')
btn8_image = btn8_image.resize((50,50), Image.Resampling.LANCZOS)
btn8_image = ImageTk.PhotoImage(btn8_image)
# --------------- Button -------------------#
btn_font = font.Font(size=25)
btn1 = tk.Button(frame1, text='Theft', height=90, width=180, fg='green',command = find_motion,
image=btn1_image, compound='left')
btn1['font'] = btn_font
btn1.grid(row=3, pady=(20,10),column=1,padx=(20,5))
btn2 = tk.Button(frame1, text='Rectangle', height=90, width=180, fg='green', command=rect_noise,
compound='left', image=btn2_image)
btn2['font'] = btn_font
...
btn3['font'] = btn_font
btn3.grid(row=5, pady=(20,10),column=1,padx=(20,5))
btn4 = tk.Button(frame1, text='Record', height=90, width=180, fg='green', command=record,
...
btn7 = tk.Button(frame1, text="Add Face", fg='green',command=maincall, compound='left',
image=btn7_image, height=90, width=180)
btn7['font'] = btn_font
btn7.grid(row=6, column=1, pady=(20,10),padx=(20,5))
btn8 = tk.Button(frame1, text="Face", fg='green',command=face, compound='left',
image=btn8_image, height=90, width=180)
btn8['font'] = btn_font
btn8.grid(row=3, column=2, pady=(20,10))
frame1.pack()
window.mainloop()